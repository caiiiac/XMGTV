...
protocol SANPageCollectionViewDelegate : class {
...
class SANPageCollectionView: UIView {
    ...
    weak var delegate : SANPageCollectionViewDelegate?
    
    fileprivate var titles : [String]
    fileprivate var isTitleInTop : Bool
    fileprivate var style : SANTitleStyle
    fileprivate var layout : SANPageCollectionViewLayout
...
extension SANPageCollectionView : UICollectionViewDelegate {
...
extension SANPageCollectionView : SANTitleViewDelegate {
