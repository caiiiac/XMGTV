...
class GiftListView: UIView, NibLoadable {
    ...
    fileprivate var pageCollectionView : SANPageCollectionView!
...
extension GiftListView {
    ...
    fileprivate func setupGiftView() {
        ...
        pageCollectionView = SANPageCollectionView(frame: pageViewFrame, titles: ["热门", "高级", "豪华", "专属"], style: style, isTitleInTop: true, layout : layout)
...
// MARK:- 数据设置
extension GiftListView : SANPageCollectionViewDataSource, SANPageCollectionViewDelegate {
